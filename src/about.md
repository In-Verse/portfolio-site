...
Hello, I am Rosemary Davies!

I am a Linux systems administrator with a strong DevOps focus, experienced in managing infrastructure across diverse environments at scale. I’ve learned to herd computers in different contexts. I have managed Windows lab environments and thousands of engineering servers! I enjoy the problem solving that comes with inheriting different ecosystems. I love automation (ansible) and scripting (bash/python) to drive reliability, performance, and efficiency. 
...
- [DC862](https://dc862.org/)
- [ScarletCTF](https://2026.ctf.rusec.club/)
- [PascalCTF](https://ctf.pascalctf.it/challenges)
- [LA CTF](https://lac.tf/)
...
When I'm not sitting in front of a computer, you can find me picking up trash around different NYC neighborhoods with the [Pickup Pigeons](https://www.instagram.com/pickuppigeons/) on Thursdays and as a volunteer bike mechanic at the [Times Up!](https://timesup.bike/) bike co-op. My hobbies include making papercraft, using my soroban (abacus), and taking long walks in the city.
